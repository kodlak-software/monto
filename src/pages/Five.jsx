...
const Five = () => {
    return (
        <div className="w-full relative  flex h-[1300px] lg:h-[450px]">
            <div className="w-full block lg:flex h-full">

                <div className="w-full lg:w-1/2   lg:h-[450px]">
                
                </div>
                <div className="w-full lg:w-1/2 bg-transparent lg:bg-gray-100  lg:h-[450px]">
                
                </div>

            </div>
            <div className="container absolute top-[100px] lg:top-0 left-1/2 transform -translate-x-1/2  block lg:flex px-5">
                ...
                <div className="block lg:flex">
                    ...
                    <div className="w-full lg:w-1/2  py-5 bg-gray-100 lg:bg-transparent">
                        ...
                        <div className="w-full block lg:flex justify-end lg:shadow-md">
